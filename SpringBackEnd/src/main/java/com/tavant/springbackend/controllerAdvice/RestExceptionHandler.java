...
import com.tavant.springbackend.errorresponse.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleConstraintViollation(ConstraintViolationException exception) {
		System.out.println("inside the exception handler");
		ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST);
		apiError.setMessage("violation error");
